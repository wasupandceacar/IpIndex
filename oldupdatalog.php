      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="coll">
          <ul class="nav navbar-nav">
            <li><a href="oldlneta.php" target="_self">统计表格</a></li>
            <li><a href="oldlnetachart.html" target="_self">统计图形</a></li>
            <li class="active"><a href="oldupdatalog.php" target="_self">维护日志</a></li>
          </ul>
        </div>
      </div>
    </div>
